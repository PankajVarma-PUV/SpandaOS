# UltimaRAG: Architecture & Agent Connectivity Overview

This document provides a macroscopic view of the UltimaRAG system, mapped directly from the source of truth (`AI_Agnets.md`). 

The diagram below maps all **30 distinct agents and subsystems** and traces the data flow from ingestion to final response.

## UltimaRAG Connectivity Diagram
